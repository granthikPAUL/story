...
public class ExtentReportManager 
{
    ...
    public static ExtentReports getReportInstance()
    {
    	...
    	if( report == null)
        {
            ...
            report.setSystemInfo("Build Number", "10.1.2");
            report.setSystemInfo("Browser", "chrome");
            
            //Stating some of the project info in the report
            htmlReporter.config().setDocumentTitle("Risks Automation Results on MainSpring");
            htmlReporter.config().setReportName("All required details of Risks Automation");
